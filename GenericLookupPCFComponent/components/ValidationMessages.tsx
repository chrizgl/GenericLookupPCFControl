...
class ValidationMessages extends React.Component<iMessages> {
    ...
    expandValidationSection = (e: any) => {
        if (e.keyCode === undefined || e.keyCode === 13) this.setState({ expandValidations: !this.state.expandValidations });
    };
    render() {
        return (
            <div>
                <div className={`SaveStatusBarDiv btn-toolbar ${this.props.validations.length > 0 ? 'ShowElement' : 'HideElement'}`}>
                    <div
                        tabIndex={0}
                    ...
                    <div tabIndex={0} className={`${this.state.expandValidations ? 'ShowElementBlock' : 'HideElement'}`}>
                        <div>
                ...
                <div className={`SaveStatusBarDiv btn-toolbar ${this.props.warnings.length > 0 ? 'ShowElement' : 'HideElement'}`}>
                    <div
                        tabIndex={0}
